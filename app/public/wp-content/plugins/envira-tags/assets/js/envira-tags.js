;(function ( $, window, document ) {
	...
	var obj = null,
        ...
        $(document).on( 'envira_gallery_api_enviratope', function( e, obj ) {

            var tags_display = obj.data.tags_display;

			$('#envira-tags-filter-list-' + obj.id).on('click', 'a.envira-tags-filter-link', function(e){
                e.preventDefault();
                ...
                $('#envira-gallery-' + obj.id + ' > div.envira-gallery-item').each(function() {
