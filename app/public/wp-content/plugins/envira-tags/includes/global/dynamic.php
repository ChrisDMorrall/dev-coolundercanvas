...
class Envira_Tags_Dynamic {
     ...
     */
    function maybe_cache_transient( $transient, $gallery_data ) {
    ...
    */
    function get_images_by_tag( $dynamic_data, $id, $data ) {
        ...
        $operator = ( isset( $data['config']['operator'] ) && in_array( sanitize_text_field( $data['config']['operator'] ), $allowed_operators ) ) ? $data['config']['operator'] : 'IN';
