	            	...
	            	<form action="edit.php?post_type=envira&amp;page=envira-gallery-settings#!envira-tab-tags" method="post">
            			...
            			<tr id="envira-settings-imagga-enabled-box">
		                    ...
		                    <td>
	                            ...
	                            <p class="description"><?php echo sprintf( __( 'Imagga will read each image you upload to ' . ( apply_filters('envira_whitelabel', false ) ? __( apply_filters('envira_whitelabel_name_singular', false ) ) : 'Envira' ) . ', and automatically tag it. <a href="%s" target="_blank">Find out more</a>', 'envira-tags' ) , 'https://imagga.com/' ); ?></p>
		                    </td>
		                </tr>
