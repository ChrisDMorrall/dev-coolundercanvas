...
class Widget extends \ WP_Widget {
    ...
    public function widget_get_albums() {
        ...
        if ( is_array( $albums ) ) {
            foreach ( $albums as $album ) {
                ...
                } else if ( ! empty( $album['config']['title'] ) ) {
                ...
                $albums_array[] = array( 'gallery_title' => $title, 'gallery_id' => '' . $album['id'] . '' );
    ...
    public function form( $instance ) {
        ...
        <p>           
            ...
            <?php /* <select id="<?php echo esc_attr( $this->get_field_id( 'envira_album_id' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'envira_album_id' ) ); ?>" style="width: 100%;">
                <?php
