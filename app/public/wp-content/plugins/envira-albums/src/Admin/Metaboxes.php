...
class Metaboxes {
    ...
    public function meta_box_callback( $post ) {
        ...
        // Load view
        envira_album_load_admin_partial( 'metabox-album-settings', array(
            'post'  => $post,
    ...
    public function meta_box_album_code_callback( $post ) {
        ...
        // Load view
        envira_album_load_admin_partial( 'metabox-album-code', array(
            'post'        => $post,
            'album_data'  => get_post_meta( $post->ID, '_eg_album_data', true ),
        ) );
                ...
                <table class="form-table" style="margin-bottom: 0;">
                    <tbody>
                        <tr id="envira-config-justified-row-height">
                            ...
                            <td>
                                <input id="envira-config-justified-row-height" type="number" name="_eg_album_data[config][justified_row_height]" value="<?php echo envira_albums_get_config( 'justified_row_height', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-gallery' ); ?></span>
                        ...
                        <tr id="envira-config-justified-margins">
                            ...
                            <td>
                                <input id="envira-config-justified-margins" type="number" name="_eg_album_data[config][justified_margins]" value="<?php echo envira_albums_get_config( 'justified_margins', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-gallery' ); ?></span>
            ...
            <div id="envira-config-description-settings-box">
                <table class="form-table no-bottom-margin">
                    ...
                    <tr id="envira-config-back-location">
                        <th scope="row">
                            <label for="envira-config-back-label"><?php _e( 'Back to Album Link Location:', 'envira-albums' ); ?></label>
                        </th>
                            <td>
                                ...
                                <p class="description"><?php _e( 'Sets where the link is displayed.', 'envira-albums' ); ?></p>
                            </td>
                    </tr>
                    ...
                    <tr id="envira-config-lazy-loading-delay">
                        <th scope="row">
                            ...
                            <td>
                                <input id="envira-config-lazy-loading-delay" type="number" name="_eg_album_data[config][lazy_loading_delay]" value="<?php echo envira_albums_get_config( 'lazy_loading_delay', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'milliseconds', 'envira-gallery' ); ?></span>
                    ...
                    <tr id="envira-config-album-width-box">
                        ...
                        <td>
                            <input id="envira-config-album-width" type="number" name="_eg_album_data[config][album_width]" value="<?php echo envira_albums_get_config( 'album_width', $album_data ); ?>" /> <span class="envira-unit"><?php _e( '%', 'envira-albums' ); ?></span>
            ...
            <div id="envira-config-standard-settings-box">
                <table class="form-table">
                    ...
                    <tr id="envira-config-gutter-box">
                        ...
                        <td>
                            <input id="envira-config-gutter" type="number" name="_eg_album_data[config][gutter]" value="<?php echo envira_albums_get_config( 'gutter', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-albums' ); ?></span>
                    ...
                    <tr id="envira-config-margin-box">
                        ...
                        <td>
                            <input id="envira-config-margin" type="number" name="_eg_album_data[config][margin]" value="<?php echo envira_albums_get_config( 'margin', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-albums' ); ?></span>
                    ...
                    <tr id="envira-config-sorting-box">
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e( 'Choose the sort order for your galleries.', 'envira-albums' ); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr id="envira-config-crop-size-box">
                        ...
                        <td>
                            <input id="envira-config-crop-width" type="number" name="_eg_album_data[config][crop_width]" value="<?php echo envira_albums_get_config( 'crop_width', $album_data ); ?>" /> &#215; <input id="envira-config-crop-height" type="number" name="_eg_album_data[config][crop_height]" value="<?php echo envira_albums_get_config( 'crop_height', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-albums' ); ?></span>
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr id="envira-config-thumbnails-width-box">
                        ...
                        <td>
                            <input id="envira-config-thumbnails-width" type="number" name="_eg_album_data[config][thumbnails_width]" value="<?php echo envira_albums_get_config( 'thumbnails_width', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-albums' ); ?></span>
                    ...
                    <tr id="envira-config-thumbnails-height-box">
                        ...
                        <td>
                            <input id="envira-config-thumbnails-height" type="number" name="_eg_album_data[config][thumbnails_height]" value="<?php echo envira_albums_get_config( 'thumbnails_height', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-albums' ); ?></span>
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr id="envira-config-mobile-size-box">
                        ...
                        <td>
                            <input id="envira-config-mobile-width" type="number" name="_eg_album_data[config][mobile_width]" value="<?php echo envira_albums_get_config( 'mobile_width', $album_data ); ?>" /> &#215; <input id="envira-config-mobile-height" type="number" name="_eg_album_data[config][mobile_height]" value="<?php echo envira_albums_get_config( 'mobile_height', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-albums' ); ?></span>
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr id="envira-config-mobile-thumbnails-width-box">
                        ...
                        <td>
                            <input id="envira-config-mobile-thumbnails-width" type="number" name="_eg_album_data[config][mobile_thumbnails_width]" value="<?php echo envira_albums_get_config( 'mobile_thumbnails_width', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-gallery' ); ?></span>
                    ...
                    <tr id="envira-config-mobile-thumbnails-height-box">
                        ...
                        <td>
                            <input id="envira-config-mobile-thumbnails-height" type="number" name="_eg_album_data[config][mobile_thumbnails_height]" value="<?php echo envira_albums_get_config( 'mobile_thumbnails_height', $album_data ); ?>" /> <span class="envira-unit"><?php _e( 'px', 'envira-gallery' ); ?></span>
                ...
                <tbody>
                    <tr id="envira-config-standalone-box">
                            ...
                            <td>
                                ...
                                <p class="description"><?php _e( 'By default we use single.php, which is the default template of the single blog post in your theme.', 'envira-albums' ); ?></p>

                                <?php else: ?>

                                <p class="description"><?php _e( 'Your current theme does not have any custom templates. If you want to use a template besides the default, you need to add a custom template to your theme.', 'envira-albums' ); ?></p>
